...
VALUES
    ('b1c2d3e4-e29b-41d4-a716-446655440004', 'a1b2c3d4-e29b-41d4-a716-446655440001', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP + INTERVAL '1' HOUR, CURRENT_TIMESTAMP),
    ('b1c2d3e4-e29b-41d4-a716-446655440005', 'a1b2c3d4-e29b-41d4-a716-446655440002', CURRENT_TIMESTAMP + INTERVAL '2' HOUR, CURRENT_TIMESTAMP + INTERVAL '3' HOUR, CURRENT_TIMESTAMP),
    ('b1c2d3e4-e29b-41d4-a716-446655440006', 'a1b2c3d4-e29b-41d4-a716-446655440003', CURRENT_TIMESTAMP + INTERVAL '4' HOUR, CURRENT_TIMESTAMP + INTERVAL '5' HOUR, CURRENT_TIMESTAMP);